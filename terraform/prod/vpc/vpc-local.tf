locals {
  name                           = "scarfall-prod"
  cidr                           = "10.70.0.0/16"
  public_subnets                 = ["10.70.0.0/20", "10.70.16.0/20", "10.70.32.0/20"]
  public_dedicated_network_acl   = true
  private_subnets                = ["10.70.48.0/20", "10.70.64.0/20", "10.70.80.0/20"]
  private_dedicated_network_acl  = true
  database_subnets               = ["10.70.96.0/20", "10.70.112.0/20", "10.70.128.0/20"]
  ...
  public_inbound_acl_rules = [
    ...
    { "rule_number" : 9800, "protocol" : "-1", "from_port" : 0, "to_port" : 0, "cidr_block" : "10.70.0.0/16", "rule_action" : "allow" },
